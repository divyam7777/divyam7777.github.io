...
function App() {
  ...
  const commandItems = [
    ...
    { label: "Stocks info", href: "/india/", icon: ArrowUpRight },
    ...
    <main className="page-shell">
      ...
      <nav className="nav">
        ...
        <div className="nav-links">
          ...
          <a href="/india/" aria-label="Open stocks scanner"><ArrowUpRight size={16} />Stocks Info</a>
      ...
      <section id="top" className="hero">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            ...
            <a href="/india/" className="button button-secondary"><ArrowUpRight size={18} />Stocks Info</a>
          </div>
